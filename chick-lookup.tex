...
\rulename{Diff-\LCMod-There}), or being dropped (Rule
\rulename{Diff-\LCDrop-There}), we simply keep looking recursively into the
remaining context.  Finally, if the context has undergone a permutation (Rule
\rulename{Diff-\LCPermute}), we can permute the context appropriately and keep
looking recursively.
