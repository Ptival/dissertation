...
\subsubsection{List diff} \label{list-diff}
...
\subsubsection{Term diff}\label{chick-diffs-term-diff}
...
\subsubsection{Other diff types}
...
\subsubsection{Example of a program diff}
