...
\newcommand{\deltaConstructorType}[8]{ \deltaConstructorTypeOp\op{(}
...
\newcommand{\MathSameType}[1]{\MathSame{}_{\TypeAsText{#1}}}
\newcommand{\MathSameInductive}{\MathSameType{Inductive}}
\newcommand{\MathSameList}{\MathSameType{List}}
\newcommand{\MathSameUniverse}{\MathSameType{Universe}}

\newcommand{\deltaType}[1]{\delta_{\TypeAsText{#1}}}
